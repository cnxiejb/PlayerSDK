...
+ (IJKFFOptions *)optionsByDefault
{
    ...
    //add xiejb
    [options setPlayerOptionIntValue:5000   forKey:@"pkt_cached_duration"];
    [options setPlayerOptionIntValue:1     forKey:@"inbuf"];//for realtime stream
    [options setPlayerOptionIntValue:0     forKey:@"packet-buffering"];//close buffer
    ...
    [options setFormatOptionIntValue:5 * 60            forKey:@"reconnect_delay_max"];
    [options setFormatOptionIntValue:1                forKey:@"reconnect_streamed"];
    [options setFormatOptionIntValue:30 * 1000 * 1000   forKey:@"timeout"];
    [options setFormatOptionValue:@"mint"              forKey:@"user_agent"];
    
    //add by xiejb
    [options setFormatOptionIntValue:1024 * 8      forKey:@"probesize"];
    [options setFormatOptionIntValue:100 * 1000     forKey:@"analyzeduration"];
