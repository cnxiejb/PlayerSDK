...
//millisecond
#define MIN_CACHED_DURATION     1500
#define DEFAULT_CACHED_DURATION 5000
#define MAX_CACHED_DURATION     8000
//senconds
#define REDUCE_CACHED_DURATION_INTERVAL   10
//millisecond
#define REDUCE_CACHED_DURATION_SIZE       100
...
typedef struct VideoState {
    ...
    // Add by xie
    // for low delay time with live play(realtime), control videoq/audioq duration < pkt_cached_duration
    // realtime set to 0, pkt_cached_duration = 0 means is playback
#ifdef PKT_CACHED_DURATION
    int pkt_cached_duration;
    int64_t cut_cached_duration_base;
#endif
   
    //add by xie
#ifdef START_READ_FRAME_TIME
    int64_t start_read_frame_time; //ms
    int64_t last_start_read_frame_time;
#endif
